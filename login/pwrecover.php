                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">別擔心,我們會向您發送訊息幫助您重設密碼</p>
                                </div>
                                ...
                                <form action="#">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="email" id="emailaddress" required="" placeholder="請輸入帳號">
                                    </div>

                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-primary btn-block" type="submit"> 重設密碼 </button>
                                    </div>
