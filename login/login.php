                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                        ...
                                        <div class="card-box">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <label for="materialFormCardPasswordEx"
                                                    class="font-weight-light">密碼</label>
                                            ...
                                            <div class="p-sm-3">
                                                <div class="radio form-check-inline">
                                                    <input type="radio" id="writer" value="投稿者" name="status"
                                                        checked="">
                                            ...
                                            <div class="form-group mb-0 text-center">
                                                <button class="btn button btn-block"
                                                    style="color: #ffffff; background-color: #045aaa;" type="submit"> 登入
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                ...
                                <p class="text-white-50">還沒註冊嗎? <a href="register.php"
                                        class="text-white ml-1"><b>註冊</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
