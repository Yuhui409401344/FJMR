            ...
            <form id="regForm" action="register-output.php" method="post">
              ...
              <div class="tab">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="email" id="email" required placeholder="請輸入Email" name="email">
                </div>      
              </div>
              ...
              <div class="tab">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="school" required placeholder="請輸入您所在的學校" name="school">
                </div>  
                <div class="form-group">
