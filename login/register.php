            ...
            <form id="regForm" action="register-output.php" method="post">
                ...
                <div class="tab">
                    <div class="form-group">
                        ...
                        <input class="form-control " type="text" id="name" placeholder="請輸入姓名" required name="name" maxlength="20">
                    </div>
                    <div class="form-group">
                ...
                <div class="tab">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="login" required placeholder="請輸入帳號" name="login" maxlength="50">
                    </div>
                    <div class="form-group">
