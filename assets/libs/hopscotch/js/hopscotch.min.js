...
!(function (a, b) {
    ...
    var a,
        ...
        u = !1,
        v = /^[a-zA-Z]+[a-zA-Z0-9_-]*$/,
        w = { left: 'right', right: 'left' }
    try {
        n(window.sessionStorage) !== q &&
            ((t = !0),
    ...
    ;(l = {
        ...
        (h = {
            addClass: function (a, b) {
                var c, d, e, f
                if (a.className) {
                    for (d = b.split(/\s+/), c = ' ' + a.className + ' ', e = 0, f = d.length; f > e; ++e)
                        c.indexOf(' ' + d[e] + ' ') < 0 && (c += d[e] + ' ')
        ...
        h.addEvtListener(window, 'load', k),
        ...
        (b.prototype = {
            ...
            setPosition: function (a) {
                ...
                if (
                    (h.flipPlacement(a),
                    h.normalizePlacement(a),
                    (c = k.offsetWidth),
                    (b = k.offsetHeight),
                    h.removeClass(k, 'fade-in-down fade-in-up fade-in-left fade-in-right'),
                    (d = j.getBoundingClientRect()),
                    (i = a.isRtl ? d.right - c : d.left),
                    'top' === a.placement)
                )
                    (e = d.top - b - this.opt.arrowWidth), (f = i)
                    ...
                    if ('right' !== a.placement)
                        throw new Error('Bubble placement failed because step.placement is invalid or undefined!')
                    ;(e = d.top), (f = d.right + this.opt.arrowWidth)
                }
                ;(g = 'center' !== a.arrowOffset ? h.getPixelValue(a.arrowOffset) : a.arrowOffset),
                    g
                        ? 'top' === a.placement || 'bottom' === a.placement
                            ? ((l.style.top = ''),
                              'center' === g
                                  ? (l.style[m] = Math.floor(c / 4 - l.offsetWidth / 4) + 'px')
                                  : (l.style[m] = g + 'px'))
                            : ('left' === a.placement || 'right' === a.placement) &&
                              ((l.style[m] = ''),
                              'center' === g
                                  ? (l.style.top = Math.floor(b / 4 - l.offsetHeight / 4) + 'px')
                                  : (l.style.top = g + 'px'))
                        : ((l.style.top = ''), (l.style[m] = '')),
                    'center' === a.xOffset
                        ? (f = d.left + j.offsetWidth / 4 - c / 4)
                        : (f += h.getPixelValue(a.xOffset)),
                    'center' === a.yOffset
                        ? (e = d.top + j.offsetHeight / 4 - b / 4)
                        : (e += h.getPixelValue(a.yOffset)),
                    a.fixedElement || ((e += h.getScrollTop()), (f += h.getScrollLeft())),
                    (k.style.position = a.fixedElement ? 'fixed' : 'absolute'),
                    (k.style.top = e + 'px'),
                    (k.style.left = f + 'px')
            },
            render: function (a, b, c) {
                ...
                if (
                    ...
                    this.opt.isTourBubble
                        ? ((i = m.getCurrTour()),
                          i &&
                              ((e = i.customData),
                              (d = i.customRenderer),
                              (a.isRtl = a.hasOwnProperty('isRtl')
                                  ? a.isRtl
                                  : i.hasOwnProperty('isRtl')
                                  ? i.isRtl
                                  : this.opt.isRtl),
                              (g = i.unsafe),
                              Array.isArray(i.steps) &&
                                  ((j = i.steps.length),
                                  (k = this._getStepI18nNum(this._getStepNum(j - 1))),
                                  (n = this._getStepNum(b) === this._getStepNum(j - 1)))))
                        : ((e = a.customData),
                          (d = a.customRenderer),
                          (g = a.unsafe),
                          (a.isRtl = a.hasOwnProperty('isRtl') ? a.isRtl : this.opt.isRtl)),
                    (l = n
                        ? h.getI18NString('doneBtn')
                        : a.showSkip
                        ? h.getI18NString('skipBtn')
                        : h.getI18NString('nextBtn')),
                    h.flipPlacement(a),
                    h.normalizePlacement(a),
                    ...
                    (q = {
                        ...
                        buttons: {
                            showPrev:
                                h.valOrDefault(a.showPrevButton, this.opt.showPrevButton) && this._getStepNum(b) > 0,
                    ...
                    if (!m.templates || 'function' != typeof m.templates[d])
                        throw new Error('Bubble rendering failed - template "' + d + '" is not a function.')
                    r.innerHTML = m.templates[d](q)
                } else if (f) r.innerHTML = f(q)
                else {
                    if (!m.templates || 'function' != typeof m.templates[o])
                        throw new Error('Bubble rendering failed - template "' + o + '" is not a function.')
                ...
                return (
                    (r.style.zIndex = 'number' == typeof a.zindex ? a.zindex : ''),
                    this._setArrow(a.placement),
                    this.hide(!1),
                    this.setPosition(a),
                    c && c(!a.fixedElement),
                    this
            ...
            _setArrow: function (a) {
                h.removeClass(this.arrowEl, 'down up right left'),
                    'top' === a
                        ? h.addClass(this.arrowEl, 'down')
                        : 'bottom' === a
                        ? h.addClass(this.arrowEl, 'up')
                        : 'left' === a
                        ? h.addClass(this.arrowEl, 'right')
                        : 'right' === a && h.addClass(this.arrowEl, 'left')
            },
            ...
            show: function () {
                var a = this,
                    ...
                    c = 1e3
                return (
                    h.removeClass(this.element, 'hide'),
                    h.addClass(this.element, b),
                    setTimeout(function () {
            ...
            hide: function (a) {
                var b = this.element
                return (
                    (a = h.valOrDefault(a, !0)),
                    (b.style.top = ''),
                    (b.style.left = ''),
                    a
                        ? (h.addClass(b, 'hide'), h.removeClass(b, 'invisible'))
                        : (h.removeClass(b, 'hide'), h.addClass(b, 'invisible')),
                    h.removeClass(b, 'animate fade-in-up fade-in-down fade-in-right fade-in-left'),
                    (this.isShowing = !1),
                    this
                )
            },
            ...
            _handleBubbleClick: function (a) {
                function b(c) {
                    return c === a.currentTarget
                        ? null
                        : h.hasClass(c, 'hopscotch-cta')
                        ? 'cta'
                        : h.hasClass(c, 'hopscotch-next')
                        ? 'next'
                        : h.hasClass(c, 'hopscotch-prev')
                        ? 'prev'
                        : h.hasClass(c, 'hopscotch-close')
                        ? 'close'
                        : b(c.parentElement)
                }
                var c
                ...
                if (((c = b(d)), 'cta' === c))
                    this.opt.isTourBubble || m.getCalloutManager().removeCallout(this.currStep.id),
                        this.currStep.onCTA && h.invokeCallback(this.currStep.onCTA)
                    ...
                    if (this.opt.isTourBubble) {
                        ...
                        this.opt.onClose && h.invokeCallback(this.opt.onClose),
                            this.opt.id && !this.opt.isTourBubble
                                ? m.getCalloutManager().removeCallout(this.opt.id)
                                : this.destroy()
            ...
            init: function (a) {
                ...
                ;(this.element = f),
                    ...
                    (a = ('undefined' == typeof a ? 'undefined' : n(a)) === q ? {} : a),
                    h.extend(e, a),
                    (this.opt = e),
                    (f.className = 'hopscotch-bubble animated'),
                    e.isTourBubble
                        ? ((d = m.getCurrTour()), d && h.addClass(f, 'tour-' + d.id))
                        : h.addClass(f, 'hopscotch-callout no-number'),
                    (b = function () {
                        !i &&
                            g.isShowing &&
                            ((i = !0),
                    ...
                    h.addEvtListener(window, 'resize', b),
                    (this.clickCb = function (a) {
                        g._handleBubbleClick(a)
                    }),
                    h.addEvtListener(f, 'click', this.clickCb),
                    this.hide(),
                    h.documentIsReady()
                        ...
                        : (document.addEventListener
                          ...
                          h.addEvtListener(window, 'load', c))
            },
        }),
        (c = function () {
            var a = {},
            ...
            ;(this.createCallout = function (d) {
                ...
                if (!v.test(d.id))
                    throw new Error(
                        'Callout ID is using an invalid format. Use alphanumeric, underscores, and/or hyphens only. First character must be a letter.'
                    )
                ...
                return (
                    (d.showNextButton = d.showPrevButton = !1),
                    (d.isTourBubble = !1),
                    (e = new b(d)),
                    (a[d.id] = e),
                    (c[d.id] = d),
                    e.render(d, null, function () {
                ...
                (this.refreshCalloutPositions = function () {
                    ...
                    for (b in a)
                        a.hasOwnProperty(b) &&
                            c.hasOwnProperty(b) &&
                            ((d = a[b]), (e = c[b]), d && e && d.setPosition(e))
                })
        }),
        (a = function (a) {
            var d,
                ...
                C = function (a) {
                    return (
                        (d && d.element && d.element.parentNode) || (d = new b(p)),
                        a &&
                            h.extend(d.opt, {
                ...
                H = function (a) {
                    ...
                    t >= v && (t <= v + E('scrollTopMargin') || w >= u)
                        ? a && a()
                        : E('smoothScroll')
                        ? ('undefined' == typeof YAHOO ? 'undefined' : n(YAHOO)) !== q &&
                          n(YAHOO.env) !== q &&
                          n(YAHOO.env.ua) !== q &&
                          n(YAHOO.util) !== q &&
                          n(YAHOO.util.Scroll) !== q
                            ? ((b = YAHOO.env.ua.webkit ? document.body : document.documentElement),
                              (d = YAHOO.util.Easing ? YAHOO.util.Easing.easeOut : void 0),
                              (c = new YAHOO.util.Scroll(b, { scroll: { to: [0, x] } }, E('scrollDuration') / 1e3, d)),
                              c.onComplete.subscribe(a),
                              c.animate())
                            : s
                            ? jQuery('body, html').animate({ scrollTop: x }, E('scrollDuration'), a)
                            : (0 > x && (x = 0),
                              (e = v > t ? -1 : 1),
                              (f = Math.abs(v - x) / (E('scrollDuration') / 10)),
                              (g = function () {
                                  var b = h.getScrollTop(),
                                      c = b + e * f
                                  return (e > 0 && c >= x) || (0 > e && x >= c)
                                      ? ((c = x), a && a(), void window.scrollTo(0, c))
                                      : (window.scrollTo(0, c),
                                        h.getScrollTop() === b ? void (a && a()) : void setTimeout(g, 10))
                              })())
                        : (window.scrollTo(0, x), a && a())
                },
                I = function P(a, b) {
                    var c, d, e
                    u + a >= 0 && u + a < t.steps.length
                        ? ((u += a),
                          (d = F()),
                          (e = function () {
                              ;(c = h.getStepTarget(d)),
                                  c
                                      ? (A[u] && delete A[u], b(u))
                                      : ((A[u] = !0), h.invokeEventCallbacks('error'), P(a, b))
                          }),
                          d.delay ? setTimeout(e, d.delay) : e())
                        : b(-1)
                },
                J = function (a, b) {
                    var c,
                    ...
                    if (
                        ...
                        (a = h.valOrDefault(a, !0)),
                        (c = F()),
                        c.nextOnTargetClick && h.removeEvtListener(h.getStepTarget(c), 'click', G),
                        (d = c),
                        (e = b > 0 ? d.multipage : u > 0 && t.steps[u - 1].multipage),
                        (f = function (c) {
                            var f
                            ...
                            if (
                                (a &&
                                    (f =
                                        b > 0
                                            ? h.invokeEventCallbacks('next', d.onNext)
                                            : h.invokeEventCallbacks('prev', d.onPrev)),
                                c === u)
                            ) {
                                if (e) return void N()
                        ...
                        if (((u += b), (c = F()), !h.getStepTarget(c) && !e))
                            return h.invokeEventCallbacks('error'), this.endTour(!0, !1)
                        f.call(this, u)
                ...
                K = function (a) {
                    ...
                    return (
                        y.call(this, e, !0),
                        (c = h.getState(E('cookieName'))),
                        c &&
                            ((d = c.split(':')),
                            (w = d[0]),
                            (x = d[1]),
                            d.length > 2 && (B = d[2].split(',')),
                            (x = parseInt(x, 10))),
                        this
                    )
                },
                ...
                M = function (a) {
                    ...
                    var c = t.steps[a],
                        d = C(),
                        e = h.getStepTarget(c)
                    u !== a && F().nextOnTargetClick && h.removeEvtListener(h.getStepTarget(F()), 'click', G),
                        (u = a),
                        d.hide(!1),
                        d.render(c, a, function (a) {
            ...
            ;(this.getCalloutManager = function () {
                ...
                (this.startTour = function (a, b) {
                    ...
                    if (!t) {
                        ...
                        if (!a.id || !v.test(a.id))
                            throw new Error(
                                'Tour ID is using an invalid format. Use alphanumeric, underscores, and/or hyphens only. First character must be a letter.'
                            )
                        ;(t = a), K.call(this, a)
                    }
                    ...
                    return (
                        L(d, e, function (a) {
                            ...
                            return b
                                ? (h.invokeEventCallbacks('start'),
                                  (c = C()),
                                  c.hide(!1),
                                  (f.isActive = !0),
                                  void (h.getStepTarget(F())
                                      ? f.showStep(a)
                                      : (h.invokeEventCallbacks('error'), E('skipIfNoElement') && f.nextStep(!1))))
                                : void f.endTour(!1, !1)
                        }),
                        this
                    )
                ...
                (this.showStep = function (a) {
                    ...
                    return h.getStepTarget(b)
                        ? (b.delay
                              ...
                              : M(a),
                          this)
                        : ((u = a), h.invokeEventCallbacks('error'), void (u = c))
                }),
                ...
                (this.endTour = function (a, b) {
                    ...
                    return (
                        (a = h.valOrDefault(a, !0)),
                        (b = h.valOrDefault(b, !0)),
                        t &&
                            ((c = F()),
                            c && c.nextOnTargetClick && h.removeEvtListener(h.getStepTarget(c), 'click', G)),
                        (u = 0),
                        (x = void 0),
                        d.hide(),
                        a && h.clearState(E('cookieName')),
                        this.isActive && ((this.isActive = !1), t && b && h.invokeEventCallbacks('end')),
                ...
                (this.listen = function (a, b, c) {
                    return a && i[a].push({ cb: b, fromTour: c }), this
                }),
                ...
                (y = function (a, b) {
                    var c,
                        ...
                        i = ['next', 'prev', 'start', 'end', 'show', 'error', 'close']
                    for (
                        p || this.resetDefaultOptions(), h.extend(p, a), a && h.extend(e, a.i18n), f = 0, g = i.length;
                        g > f;
                        ++f
                    )
                        (d = 'on' + i[f].charAt(0).toUpperCase() + i[f].substring(1)),
                            a[d] && this.listen(i[f], a[d], b)
                    return (c = C(!0)), this
                }),
        ...
        function () {
            ...
            ;(a.escape = function (a) {
                return g
                    ...
                    : null == a
                    ? ''
                    : ('' + a).replace(new RegExp('[&<>"\']', 'g'), function (a) {
                          return '&' == a
                              ? '&amp;'
                              : '<' == a
                              ? '&lt;'
                ...
                (this.templates.bubble_default = function (b) {
                    function c(b, c) {
                    ...
                    return (
                        ...
                        g.showClose &&
                            (e +=
                                '<button class="hopscotch-bubble-close hopscotch-close">' +
                                (null == (d = f.closeTooltip) ? '' : d) +
                                '</button>'),
                        (e +=
