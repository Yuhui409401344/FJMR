                                ...
                                <div class="card-box">
                                     <form method=POST action="reply-output.php?title=<?php echo $title ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="product-reference" class=" font-weight-bold text-muted">標題</label><br>
                                            <b><?php echo $title ?></b>
                                        </div>

                                        <!-- 作者 -->
                                        <div class="form-group mb-3">
                                            <label for="product-reference" class=" font-weight-bold text-muted">作者</label><br>
                                        ...
                                        <!-- 留言 comment-->
                                        <div class="form-group mb-3">
                                            <label for="product-reference" class=" font-weight-bold text-muted">回覆建議</label><br>
                                            <textarea class="form-control" name="comment" rows="5" required></textarea>
                                        </div>

                                        <!-- 評級 level -->
                                        <div class="form-group mb-3">
                                            <label for="product-reference" class=" font-weight-bold text-muted">回覆評級</label><br>
