                            ...
                            <div class="card-box">
                                <div class="row">
                                    <div class="container-fluid">
                                        ...
                                        <div style=" display: flex;
                                                        ...
                                                        border-bottom: 0;">
                                            <h3
                                                style="font-weight: bolder;font-family:Microsoft JhengHei;margin-left: 60px;margin-top: 20px;">
                                                國際交換生選擇學校之關鍵因素-使用層級分析法</h3>
                                        </div>
                                        <div class="container">
                                                ...
                                                <section class="mt-3">
                                                    ...
                                                    <div class="media mt-3 px-1">
                                                        <div class="media-body"
                                                            ...
                                                            <p>隨著教育的普及，現今大學國際交換生體制之發展也逐漸成熟。除了以往的留學方式外，學生可以選擇以短期交換方式，體驗國外的生活。不僅選擇方式較為多元，學費也較以往便宜，使得國際交換人數逐年攀升。本文以AHP(Analytic
                                                                Hierarchy
                                                                Process)法探討國際交換生選擇學校之關鍵因素，先經由文獻探討建構AHP層級架構，共有4個關鍵構面及21個因素。接著設計問卷，調查了臺灣至國外交換、陸生來臺交換以及外國來臺交換三個群體的交換生，並比較此三群交換生問卷結果之差異。本研究發現對全體填答交換生而言，最重要之構面為交換國構面。而「文化、語言、宗教、習慣」、「友善安全的住所」、「旅遊考量」、「國際人脈」為前四個重要因素；最後一名因素為「打工收入」。最後，本文依研究結果提出建議，供相關部門制定交換生發展策略之參考，以促進國際交流及發展。
                                                            </p>
                                                        </div>
                                                    </div>
                                ...
                                <center>
                                    <button type="button" class="btn btn-success waves-effect waves-light">
                                        <a href="#reply-modal;" data-toggle="modal" data-target="#reply-modal"
                                            style="color: white"><span class="btn-label"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer mr-2">
                    <div class="form-group" style="text-align: right;">
                        第 <script>
                        document.getElementById('demo-custom-toolbar').getAttribute('times');
                        </script> &copy; 次回覆
                    </div>
