                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th ellipsis>作者</th>
                                                <th data-field="field" data-sortable="true" data-hide="phone">上傳日期</th>
                                        ...
                                        <tbody>
                                            <?php
                                                        ...
                                                        foreach ($pdo->query("select * from newpaper_history where uploader ='".$login."' order by uploadtime DESC") as $row) {
                                                            $id=$row["id"];
                                                            $title=$row['title'];
                                                            $author1=$row['auth1'];
                                                            $author2=$row['auth2'];
