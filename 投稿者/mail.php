                      ...
                      <form action="" method="post" >
                            ...
                            <div class="v-text-align" align="left" stye="display:flex">
                              ...
                              <button name="accept" value="0">
                                 <span style="display:block;padding:15px 40px;line-height:120%;"><span style="font-size: 18px; line-height: 21.6px; font-family: Cabin, sans-serif;">No</span></span>
                               </button>

                               <button name="accept" value="1">
                                 <span style="display:block;padding:15px 40px;line-height:120%;"><span style="font-size: 18px; line-height: 21.6px; font-family: Cabin, sans-serif;">Yes</span></span>
                               </button>

                               <input type="hidden" name="id" value="'.$id.'"></input>
                               <input type="hidden" name="reviewer" value="'.$title.'"></input>
...
$sql1=$pdo->prepare("insert into distri (accept) where id='1' and pro='paggie' VALUES(?)");
$sql1->execute([$accept]);

$sql2=$pdo->prepare("insert into distri_history (accept) whereid='1' and pro='paggie' VALUES(?)");
$sql2->execute([$accept]);
