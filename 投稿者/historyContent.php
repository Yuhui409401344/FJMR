                                            ...
                                            <div class="card mb-1 shadow-none border">
                                                <div class="p-2">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col pl-0">
                                                            非匿名檔案：
                                                            <a href='upload/<?php echo $scriptfile ?>' target="blank" download="<?php echo $scriptfile ?>"><?php echo $title ?></a>
                                                        </div>
                                                        <div class="col-auto">
                                                            <!-- Button -->
                                                            <a href='upload/<?php echo $scriptfile ?>' target="blank" download="<?php echo $scriptfile ?>">
                                            ...
                                            <div class="card mb-1 shadow-none border">
                                                <div class="p-2">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col pl-0">
                                                            匿名檔案：
                                                            <a href='upload_x/<?php echo $scriptfile ?>' target="blank" download="<?php echo $scriptfile ?>">
                                                                <?php echo $title ?>
                                                            </a>
                                                        </div>
                                                        <div class="col-auto">
                                                ...
                                                <p style="text-align: justify; padding-right: 30px;font-family:Microsoft JhengHei">
                                                    稿件評級：<?php switch ($level) {
                                                                case "接受":
                                                                    ...
                                                                    break;
                                                                case "小幅修改":
                                                                    echo  "<span class='badge badge-soft-warning'>小幅修改</span>";
                                                                    break;
                                                                case "大幅修改":
                                                                    echo  "<span class='badge badge-soft-success'>大幅修改</span>";
                                                                    break;
                                                                case "拒絕":
                                            ...
                                            <div class="card mb-1 shadow-none border">
                                                <div class="p-2">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col pl-0">
                                                            <a href='../管理者/upload/<?php echo $managerfile ?>' target="blank" download="<?php echo $managerfile ?>"><?php echo $managerfile ?></a>
                                                        </div>
                                                        <div class="col-auto">
                                                            <!-- Button -->
                                                            <a href='../管理者/upload/<?php echo $managerfile ?>' target="blank" download="<?php echo $managerfile ?>">
                                                                <i class="dripicons-download"></i>
                                                            </a>
                                                        </div>
                                                    </div>
