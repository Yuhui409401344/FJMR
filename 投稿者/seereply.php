                                    ...
                                    <div class="border border-light p-2 mb-3">
                                        ...
                                        <div class="font-16 text-left  text-dark">
                                            <label style="font-size: 20px;">
                                                <font color="#8E8E8E"><?php echo $title ?></font>
                                            </label></br>
                                            <label style="font-size: 8px;">
                                                <font color="#8E8E8E">第<?php echo  $replycount+1 ?>次回覆</font>
                                            </label>
                                            <label style="font-size: 8px;">
                                                <font color="#8E8E8E"><?php echo  $replytime?></font>
                                            </label>
                                        </div>
                                        <div>
                                            <font size="5">
                                        ...
                                        <div class="mt-2">
                                            <a href="../管理者/upload/<?php echo $filename ?>" target="blank"
                                                download="<?php echo $filename ?>" class="text-muted  mt-2"><i
                                                    class="mdi mdi-download"></i>下載回覆檔</a>
                                            &nbsp;&nbsp;
                                            <?php if($have_reply == '1'){ 
                                                    if ($level =='小幅修改' or $level =='大幅修改'){
                                                        ?>
                                            <a href="reply.php?title=<?php echo $title?>" class="text-muted  mt-2"><i
                                                    class="mdi mdi-reply"></i>上傳修正檔</a>
                                            &nbsp;&nbsp;
                                            <a href="作者回覆意見書.doc" class="text-muted  mt-2"><i
                                                    class="mdi mdi-file"></i>作者回覆範例</a>
                                            <?php 
                                                    }
                                                }
                                                ?>
