                      ...
                      <tbody>
                        <tr>
                          <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:50px 44px 15px;font-family:arial,helvetica,sans-serif;" align="left">
                            <p style="font-family: "Open Sans",sans-serif; ">親愛的投稿者您好，您在輔仁管理評論的投稿《'.$title.'》已收到回覆，請您到輔仁管理評論確認結果，謝謝您！</p>
                          </td>
                        </tr>
                        <tr>
                          <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:15px 44px 15px;font-family:arial,helvetica,sans-serif;" align="left">
                            <p style="font-family: "Open Sans",sans-serif; ">評級：'.$level.'</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
