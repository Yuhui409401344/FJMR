                            ...
                            <div class="card-box"> 
                                <div class="row">
                                    ...
                                    <form action="closeddl_mail.php" method="POST" id="closeddl">
                                        <input type="submit" id="row" class="btn btn-primary btn-sm" value="寄送信件">
                                        ...
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th data-field="date" data-sortable="true" data-align="center" data-formatter="dateFormatter">回覆日期</th>
                                                <th data-field="ddl" data-align="center" data-sortable="true">距離截稿日期</th>
                                                <th data-field="phone" data-align="center" data-sortable="false">審稿者電話</th>
                                                <th data-field="action" data-align="center" data-sortable="false">傳送信件</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><input type="checkbox" value="<?php echo $email?>" name="email[]"></td>
                                                ...
                                                <td><?php echo $tel ?></td>
                                                <td><a href="closeddl_mail.php?email=<?php echo $email?>"><i data-feather="mail" class="icon-dual-danger"></i></a></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
                            ...
                            <div class="card-box"> 
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="submit" id="demo-row" class="btn btn-primary btn-sm" value="寄送信件">
                                        <table id="demo-custom-toolbar"
                                            data-toolbar="#demo-row"
                                            data-toggle="table"
                                            data-toolbar="#toolbar"
                                            data-search="true"
                                            data-show-refresh="true"
                                        ...
                                        <thead class="thead-light">
                                            ...
                                            <tr>
                                                ...
                                                <th data-field="name" data-sortable="true">審稿者</th>
                                                <th data-field="date" data-sortable="true" data-align="center" data-formatter="dateFormatter">回覆日期</th>
                                                <th data-field="ddl" data-align="center" data-sortable="true">已超過截稿日期</th>
                                                <th data-field="phone" data-align="center" data-sortable="false">審稿者電話</th>
                                                <th data-field="action" data-align="center" data-sortable="false">傳送信件</th>
                                            ...
                                            ?>
                                            <tr>
                                                <td><input type="checkbox" value="<?php echo $mail?>" name="mail[]"></td>
                                                <td><a href="p2.php?id=<?php echo $id?>&&pro=<?php echo $pro?>"><?php echo $title ?></a></td>
                                                <td><?php echo $auth1,' ',$auth2,' ',$auth3,' ',$auth4,' ',$auth5 ?></td>
                                                <td><?php echo $name ?></td>
                                                <td><?php echo $ddl ?></td>
                                                ...
                                                <td><?php echo $tel ?></td>
                                                <td><a href="overddl_mail.php?mail=<?php echo $mail?>"><i data-feather="mail" class="icon-dual-danger"></i></a></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
