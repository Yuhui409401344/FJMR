                                    ...
                                    <div class="col-sm-12">
                                        <form action="reply.php" method="post">
                                            <table id="demo-custom-toolbar" data-toggle="table" data-toolbar="#toolbar"
                                                ...
                                                data-sort-name="date" data-page-list="[5, 10, 20]" data-page-size="6"
                                                ...
                                                <thead class="thead-light">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th data-field="status" data-align="center"
                                                            data-sortable="true">審稿者Email</th>
                                                ...
                                                foreach ($pdo->query(" SELECT distri.* from distri where not exists ( select id,reply.senter from reply where reply.id=distri.id AND reply.senter = distri.pro ) AND DATEDIFF(distri.ddl,now())<= 5 ") as $row) {
                                                    $id=$row['id'];
                                                    $title=$row['title'];
                                                    $pro=$row['pro'];
                                                    $ddl=$row['ddl'];
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><a
                                                                href="distriHistoryContent.php?id=<?php echo $id?>&&pro=<?php echo $pro?>"><?php echo $title ?></a>
                                                        </td>
