                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="text-center filter-menu">
                                    <a href="javascript: void(0);" class="filter-menu-item active"
                                        data-rel="all">All</a>
                                                ...
                                                <table data-toggle="table" data-search="true" data-show-refresh="true"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a
                                                                    href="distriHistoryContent.php?id=<?php echo $id ?>&&pro=<?php echo $pro?>"><?php echo $title ?>
                                                            </td>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <table id="demo-custom-toolbar" data-toolbar="#demo-delete-row"
                                                    ...
                                                    data-page-list="[5, 10, 20]" data-page-size="10"
                                                    ...
                                                    <thead class="thead-light">
                                                        <tr>
                                                            ...
                                                            <th data-sortable="true" data-align="center"
                                                                data-formatter="statusFormatter">回覆意見</th>
                                                            <th data-sortable="true" data-align="center"
