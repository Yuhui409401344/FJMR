                      ...
                      <tbody>
                        <tr>
                          <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:50px 44px 15px;font-family:arial,helvetica,sans-serif;" align="left">
                            <p style="font-family: "Open Sans",sans-serif; ">親愛的審稿者，'.$name.'（女士/先生)您好：輔仁管理評論現有一封分配給您的稿件《'.$title.'》，待您審查，還請您決定是否接收！</p>
                          </td>
                        </tr>
                        <tr>
...
<a href="140.136.9.232/webhw/管理者/accept.php?accept=0&id='.$id.'&reviewer='.$a.'"
...
<td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 60px;font-family:arial,helvetica,sans-serif;" align="left">
                          ...
                          <div class="v-text-align" align="center">
                              <a href="140.136.9.232/webhw/管理者/accept.php?accept=1&id='.$id.'&reviewer='.$a.'" style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration:
...
<span style="display:block;padding:15px 40px;line-height:120%;"><span
        style="font-size: 18px; line-height: 21.6px; font-family: Cabin, sans-serif;">Yes</span></span>
</a>
