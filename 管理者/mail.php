...
<a href="192.168.1.101/webhw/管理者/accept.php?accept=0&id='.$id.'&reviewer='.$a.'"
...
<td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 60px;font-family:arial,helvetica,sans-serif;" align="left">
                          ...
                          <div class="v-text-align" align="center">
                              <a href="192.168.1.101/webhw/管理者/accept.php?accept=1&id='.$id.'&reviewer='.$a.'" style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration:
