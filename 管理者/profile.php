                            ...
                            <div class="card-box text-center">
                                ...
                                <div class="text-left mt-3">
                                    ...
                                    <p class="text-muted mb-2 font-13"><strong>聯絡電話 :</strong>
                                        <span class="ml-2 "><?php echo $tel ?> </span>
                                    </p>

                                    <p class="text-muted mb-2 font-13"><strong>任職學校 :</strong>
                                        <span class="ml-2 "><?php echo $schoolnow ?> </span>
                                    </p>
                                    ...
                                    <div class="tab-pane show active" id="aboutme">
                                        ...
                                        <ul class="list-unstyled timeline-sm">
                                            ...
                                            <li class="timeline-sm-item">
                                                ...
                                                <h5 class="mt-0 mb-1"><?php echo $school ?> <?php echo $department ?>
                                                </h5>
                                                <p><?php echo $degree ?></p>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="firstname"
                                                            name='name_' value="<?php echo $name ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="school"
                                                            name="school" value="<?php echo $schoolnow ?>">
                                                    </div>
                                                </div>
                                            </div> <!-- end row -->
                                                        ...
                                                        <div>
                                                            <div style="margin-top: 3px;">
                                                                <?php
                                                                    ...
                                                                    $query=$pdo->query("SELECT f_name from account_field where login='".$login."' and status ='管理者'");
                                                                    $datalist=$query->fetchall();
                                                                    foreach($datalist as $datadetail){
