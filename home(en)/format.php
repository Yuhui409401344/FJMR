...
<div>
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="home.php" style="color: grey;">FJRM</a></li>
...
background-color: #F5F5F5; }
        ...
        border-radius: 10px;
        -webkit-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.1);
        background-image: -webkit-linear-gradient(330deg, #e0e0e0  0%, #bdbdbd 100%);
        background-image: linear-gradient(120deg, #e0e0e0  0%, #bdbdbd 100%); }
...
<div class="row" name='段落'>
    ...
    <div class="col-md-6 mb-4">
      ...
      <div class="card example-1 scrollbar-ripe-malinka">
        <div class="card-body">
          <h4 id="section1"><strong>段落標明方式</strong></h4>
...
1.1  Instrument（置左）</pre>
  ...
  <div class="row" name="字體">
    ...
    <div class="col-md-6 mb-4">
      ...
      <div class="card example-1 scrollbar-ripe-malinka">
        <div class="card-body">
          <h4 id="section1"><strong>字體</strong><br><br></h4>
          <p> 
            1.  題目：粗黑體22pt，置中。</br>
  ...
  <div class="row" name="注釋">
    ...
    <div class="col-md-6 mb-4">
      ...
      <div class="card example-1 scrollbar-ripe-malinka">
        <div class="card-body">
          <h4 id="section1"><strong>注釋</strong><br><br></h4>
          <p>
        附註於頁底。如下例：
        </br>
        </br>
  ...
  <div class="row" name="文獻引用">
    ...
    <div class="col-md-6 mb-4">
      ...
      <div class="card example-1 scrollbar-ripe-malinka">
        <div class="card-body">
          <h4 id="section1"><strong>文獻引用</strong><br><br></h4>
          <p> 例: 近年來有關這方面的探討逐漸受到重視，尤其在有關組織行為與人事管理研究領域中「組織承諾」
    ...
    <div class="col-md-6 mb-4">
        ...
        <div class="card example-1 scrollbar-ripe-malinka">
          <div class="card-body">
            <h4 id="section1"><strong>文獻引用</strong><br><br></h4>
            <p>例: Olson（1977）suggested that people are more likely to use price to infer product quality when judging an expensive product.</p>
          </div>
        </div>
        <!-- Exaple 1 -->
  ...
  <div class="row" name="圖表">
    ...
    <div class="col-md-6 mb-4">
      ...
      <div class="card example-1 scrollbar-ripe-malinka">
        <div class="card-body">
          <h4 id="section1"><strong>圖表</strong><br><br></h4>
          <p>
            1. 圖表置正文內。</br>
  ...
  <div class="row" name="參考文獻">
    ...
    <div class="col-md-12 mb-4">
      ...
      <div class="card example-1 scrollbar-ripe-malinka">
        <div class="card-body">
          <h4 id="section1"><strong>參考文獻（中、英文）</strong><br><br></h4>
          <pre>
