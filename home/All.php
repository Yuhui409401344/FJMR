        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="basicExampleNav">
                ...
                <ul class="navbar-nav mr-auto" style="font-size:initial">
                    ...
                    <li class="nav-item dropdown">
                        <a data-toggle="dropdown" class="nav-link w-10" aria-haspopup="true" aria-expanded="false">投稿<i
...
<body>
    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb"
                style="margin-bottom: 0px;background-color:#e9ecef;height:48px;color:#9ba1a7;font-size:1rem; font-family:roboto">
    ...
    <div class="container-fluid">
        <div class="col-12 mt-1" style="position:relative;width:100%;height:300px;padding-bottom:50%">
            <iframe src="http://www.management.fju.edu.tw/zh-tw/research/journal.php"
                style="position:absolute;top:0;left:0;width:100%;height:100%" onload=""></iframe>
        </div>
    </div>
        ...
        <div class="container-fluid text-center text-md-left">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-md-0 mb-3">
                    ...
                    <p>
                        <a href="https://ndltd.ncl.edu.tw/cgi-bin/gs32/gsweb.cgi?o=dnclcdr&amp;s=id=%22089SHU05389001%22.&amp;searchmode=basic"
                            target="blank">博碩士論文行動網</a>
                    </p>
                    <p>
