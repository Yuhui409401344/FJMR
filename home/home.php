...
<body>
    ...
    <header>
                ...
                <div class="collapse navbar-collapse" id="basicExampleNav">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            <a data-toggle="dropdown" class="nav-link w-100 dropdown-toggle" aria-haspopup="true"
                                aria-expanded="false">
                                關於
                            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        ?>
                            <a data-toggle="dropdown" class="nav-link  dropdown-toggle" aria-haspopup="true"
                                aria-expanded="false" style="font-size: small;"><i
                                    class="fas fa-user-alt"></i><?php echo $login ?></a>
                            ...
                            foreach($sql as $row){
                                ...
                                ?>
                                <a id="change" class="dropdown-item" href="../審稿者/dashboard.php"
        ...
        <div class="view"
            style="background-image: url('../assets/images/homebg.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4 white-text text-center" style="margin-top: 170px;">
                            <h1 class="h1-reponsive white-text text-uppercase font-weight-bold mb-0 pt-md-5 pt-5 wow fadeInDown"
                                data-wow-delay="0.3s"><strong>輔仁管理評論</strong></h1>
                            <hr class="hr-light my-4 wow fadeInDown" data-wow-delay="0.4s">
                            <h5 class="text-uppercase mb-4 white-text wow fadeInDown" data-wow-delay="0.4s">
                                <strong>TODAY'S RESEARCH, TOMORROW'S INNOVATION.</strong>
                            </h5>
